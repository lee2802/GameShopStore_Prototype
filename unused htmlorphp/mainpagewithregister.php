...
<body>
    ...
    <div class = "page-wrapper">
        <ul class = "topborder">
            <li class = "leftsideli active"><a href="mainpagewithregister.php" >Main Page</a></li>
            <li class = "leftsideli"><a href="loginadmin.php">Admin Log in</a></li>
            <li class = "rightsideli"><a href="Login.php">Log in</a></li>
            <li class = "rightsideli"><a href="sign-up.php">Sign-up</a></li>
